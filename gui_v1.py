...
if __name__ == "__main__":
    ...
    import librosa
    from lib.torchgate import TorchGate
    import numpy as np
                ...
                [
                    sg.Frame(
                        layout=[
                            ...
                            [
                                sg.Button(("Reload device list"), key="reload_devices"),
                                sg.Radio(
